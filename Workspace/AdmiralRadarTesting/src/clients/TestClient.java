...
public class TestClient {
	...
	public static void main(String[] args) throws IOException {
		...
		try (Socket arSocket = new Socket( HOST , PORT );
	...
	/*
	 * IRC Chat Test Base code is from http://archive.oreilly.com/pub/h/1966 TO DO: Catch exceptions internally instead
	 * of throwing them NOTE: This function will only read an IRC chat ONCE - it must be looped for proper
	 * functionality.
	 */
