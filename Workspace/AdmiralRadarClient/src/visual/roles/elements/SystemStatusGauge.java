...
public class SystemStatusGauge extends JPanel implements MouseListener{
	...
	protected void paintComponent(Graphics gin){
		...
		g.setColor(col);
		g.fillOval((int) (x_ctr - rad1*rad2/2), (int) (y_ctr - rad1*rad2/2), (int) (rad1*rad2), (int) (rad1*rad2));
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (new Ellipse2D.Double((getSize().width / 2) - rad1*rad2/2, (getSize().height / 2) - rad1*rad2/2, rad1*rad2, rad1*rad2).contains(e.getPoint())){
